...
bg_cylinder_ring1 <- simulate_rings3D(bg_sample = bg_mix,
                                     n_ring = 4,
                                     ring_properties = list(
                                       R1 = list(
                                         name_of_cluster_cell = "Void",
...
bg_ring1 <- simulate_rings3D(bg_sample = bg_cylinder_ring1,
                                  n_ring = 1,
                                  ring_properties = list(
                                    R1 = list(
...
bg_cluster1 <- simulate_clusters3D(bg_sample = bg_ring1,
                                    n_clusters = 1,
                                    cluster_properties = list(
                                      C1 = list(
...
bg_ring2 <- simulate_rings3D(bg_sample = bg_mix,
                            n_ring = 1,
                            ring_properties = list(
                              R1 = list(
                                name_of_cluster_cell = "Tumour",
...
bg_cluster2 <- simulate_clusters3D(bg_sample = bg_ring2,
                                  n_clusters = 4,
                                  cluster_properties = list(
                                    C1 = list(
                                      name_of_cluster_cell = "Tumour",
...
bg_cylinder_ring2 <- simulate_rings3D(bg_sample = bg_cluster2,
                                     n_ring = 4,
                                     ring_properties = list(
                                       R1 = list(
                                         name_of_cluster_cell = "Void",
...
Microscopy image 1.
```{r echo=FALSE}
plot_cell_categories3D(bg_cluster1,
                       c("Others", "Immune1", "Immune2", "Connective", "Tumour1", "Tumour2"),
                       c("#0077B6", "lightgreen", "green", "blue", "darkblue", "red"))
```
...
Microscopy image 2.
```{r echo=FALSE}
plot_cell_categories3D(bg_cylinder_ring2,
                       c("Others", "Immune1", "Immune2", "Connective", "Tumour"),
                       c("#0077B6", "lightgreen", "green", "blue", "red"))
