...
mixed_spes_table <- read.table("mixed_slices_spes_table.csv")

# Read ringed_spes_table
setwd("~/R/spaSim-3D/scripts/spaSim-3D & SPIAT-3D testing/spe_tables")
ringed_spes_table <- read.table("ringed_slices_spes_table.csv")

# Read separated_spes_table
setwd("~/R/spaSim-3D/scripts/spaSim-3D & SPIAT-3D testing/spe_tables")
separated_spes_table <- read.table("separated_slices_spes_table.csv")
...
plot_proportion_SAC <- function(spes_table, SAC_df, arrangement_colname) {
  ...
  for (i in seq_len(nrow(prop_cell_types))) {
    ...
    fig_arrangement <- ggplot(plot_df, aes(!!sym(arrangement_colname), proportion)) + 
      geom_point() +
      theme_bw()
    
    fig_bg_prop_A <- ggplot(plot_df, aes(bg_prop_A, proportion)) + 
      geom_point() +
      theme_bw()
    
    fig_bg_prop_B <- ggplot(plot_df, aes(bg_prop_B, proportion)) + 
      geom_point() +
      theme_bw()
    
    fig_shape <- ggplot(plot_df, aes(shape, proportion)) +
      geom_violin() +
      theme_bw()
    ...
    fig_variation_E <- ggplot(plot_df %>% filter(shape == "Ellipsoid"), aes(variation_E, proportion)) +
      geom_point() +
      theme_bw()
    
    fig_volume_E <- ggplot(plot_df %>% filter(shape == "Ellipsoid"), aes(volume_E, proportion)) +
      geom_point() +
      theme_bw()
    
    fig_width_N <- ggplot(plot_df %>% filter(!is.na(width_N)), aes(width_N, proportion)) +
      geom_point() +
      theme_bw()
    
    all_plots_list[[prop_cell_types[i, "pair"]]] <- list(arrangement = fig_arrangement,
                                                         bg_prop_A = fig_bg_prop_A, 
                                                         bg_prop_B = fig_bg_prop_B,
                                                         shape = fig_shape,
                                                         variation_E = fig_variation_E,
...
plot_entropy_SAC <- function(spes_table, SAC_df, arrangement_colname) {
  ...
  for (i in seq_len(nrow(entropy_cell_types))) {
    ...
    fig_arrangement <- ggplot(plot_df, aes(!!sym(arrangement_colname), entropy)) + 
      geom_point() +
      theme_bw()
    
    fig_bg_prop_A <- ggplot(plot_df, aes(bg_prop_A, entropy)) + 
      geom_point() +
      theme_bw()
    
    fig_bg_prop_B <- ggplot(plot_df, aes(bg_prop_B, entropy)) + 
      geom_point() +
      theme_bw()
    
    fig_shape <- ggplot(plot_df, aes(shape, entropy)) +
      geom_violin() +
      theme_bw()
    ...
    fig_variation_E <- ggplot(plot_df %>% filter(shape == "Ellipsoid"), aes(variation_E, entropy)) +
      geom_point() +
      theme_bw()
    
    fig_volume_E <- ggplot(plot_df %>% filter(shape == "Ellipsoid"), aes(volume_E, entropy)) +
      geom_point() +
      theme_bw()
    
    fig_width_N <- ggplot(plot_df %>% filter(!is.na(width_N)), aes(width_N, entropy)) +
      geom_point() +
      theme_bw()
    
    all_plots_list[[entropy_cell_types$cell_types[i]]] <- list(arrangement = fig_arrangement,
                                                               bg_prop_A = fig_bg_prop_A, 
                                                               bg_prop_B = fig_bg_prop_B,
                                                               shape = fig_shape,
                                                               variation_E = fig_variation_E,
...
plot_proportion_prevalence_AUC <- function(spes_table, prevalence_df, arrangement_colname) {
  ...
  for (i in seq_len(nrow(prop_cell_types))) {
    ...
    fig_arrangement <- ggplot(plot_df, aes(!!sym(arrangement_colname), AUC)) + 
      geom_point() +
      theme_bw()
    
    fig_bg_prop_A <- ggplot(plot_df, aes(bg_prop_A, AUC)) + 
      geom_point() +
      theme_bw()
    
    fig_bg_prop_B <- ggplot(plot_df, aes(bg_prop_B, AUC)) + 
      geom_point() +
      theme_bw()
    
    fig_shape <- ggplot(plot_df, aes(shape, AUC)) +
      geom_violin() +
      theme_bw()
    ...
    fig_variation_E <- ggplot(plot_df %>% filter(shape == "Ellipsoid"), aes(variation_E, AUC)) +
      geom_point() +
      theme_bw()
    
    fig_volume_E <- ggplot(plot_df %>% filter(shape == "Ellipsoid"), aes(volume_E, AUC)) +
      geom_point() +
      theme_bw()
    
    fig_width_N <- ggplot(plot_df %>% filter(!is.na(width_N)), aes(width_N, AUC)) +
      geom_point() +
      theme_bw()
    
    all_plots_list[[prop_cell_types$pair[i]]] <- list(arrangement = fig_arrangement,
                                                      bg_prop_A = fig_bg_prop_A, 
                                                      bg_prop_B = fig_bg_prop_B,
                                                      shape = fig_shape,
                                                      variation_E = fig_variation_E,
...
mixed_AMD_df <- read.table("mixed_slices_AMD_df.csv")

mixed_AMD_plot <- plot_AMD_metric(mixed_spes_table, mixed_AMD_df, "cluster_prop_B")

setwd("~/R/plots/2D")
saveRDS(mixed_AMD_plot, "mixed_AMD_plot2D.RDS")

### 2.3. mixed spes MS, NMS, ACINP, AE -----------------------------------

# Read mixed MS, NMS, ACINP, AE dfs
setwd("~/R/spaSim-3D/scripts/spaSim-3D & SPIAT-3D testing/analysis2D_tables/mixed")
mixed_MS_df <- read.table("mixed_slices_MS_df.csv")
mixed_NMS_df <- read.table("mixed_slices_NMS_df.csv")
mixed_ACINP_df <- read.table("mixed_slices_ACINP_df.csv")
mixed_AE_df <- read.table("mixed_slices_AE_df.csv")
...
setwd("~/R/plots/2D")
saveRDS(mixed_MS_plot, "mixed_MS_plot2D.RDS")
saveRDS(mixed_NMS_plot, "mixed_NMS_plot2D.RDS")
saveRDS(mixed_ACINP_plot, "mixed_ACINP_plot2D.RDS")
saveRDS(mixed_AE_plot, "mixed_AE_plot2D.RDS")

### 2.4. mixed spes ACIN, CKR ------------------------------------------------

# Read mixed ACIN, CKR
setwd("~/R/spaSim-3D/scripts/spaSim-3D & SPIAT-3D testing/analysis2D_tables/mixed")
mixed_ACIN_df <- read.table("mixed_slices_ACIN_df.csv")
mixed_CKR_df <- read.table("mixed_slices_CKR_df.csv")
...
setwd("~/R/plots/2D")
saveRDS(mixed_ACIN_plot, "mixed_ACIN_plot2D.RDS")
saveRDS(mixed_CKR_plot, "mixed_CKR_plot2D.RDS")

### 2.5. mixed spes SAC ------------------------------------------------------

# Read mixed_SAC_df
setwd("~/R/spaSim-3D/scripts/spaSim-3D & SPIAT-3D testing/analysis2D_tables/mixed")
mixed_prop_SAC_df <- read.table("mixed_slices_prop_SAC_df.csv")
mixed_entropy_SAC_df <- read.table("mixed_slices_entropy_SAC_df.csv")
...
setwd("~/R/plots/2D")
saveRDS(mixed_prop_SAC_plot, "mixed_prop_SAC_plot2D.RDS")
saveRDS(mixed_entropy_SAC_plot, "mixed_entropy_SAC_plot2D.RDS")

### 2.6. mixed spes prevalence ------------------------------------------------

# Read mixed prevalence dfs
setwd("~/R/spaSim-3D/scripts/spaSim-3D & SPIAT-3D testing/analysis2D_tables/mixed")
mixed_prop_prevalence_df <- read.table("mixed_slices_prop_prevalence_df.csv")
mixed_entropy_prevalence_df <- read.table("mixed_slices_entropy_prevalence_df.csv")
...
setwd("~/R/plots/2D")
saveRDS(mixed_prop_prevalence_plot, "mixed_prop_prevalence_plot2D.RDS")
saveRDS(mixed_entropy_prevalence_plot, "mixed_entropy_prevalence_plot2D.RDS")
saveRDS(mixed_prop_prevalence_AUC_plot, "mixed_prop_prevalence_AUC_plot2D.RDS")
saveRDS(mixed_entropy_prevalence_AUC_plot, "mixed_entropy_prevalence_AUC_plot2D.RDS")
...
ringed_AMD_df <- read.table("ringed_slices_AMD_df.csv")

ringed_AMD_plot <- plot_AMD_metric(ringed_spes_table, ringed_AMD_df, "ring_width_factor")

setwd("~/R/plots/2D")
saveRDS(ringed_AMD_plot, "ringed_AMD_plot2D.RDS")

### 3.3. ringed spes MS, NMS, ACINP, AE -----------------------------------

# Read ringed MS, NMS, ACINP, AE dfs
setwd("~/R/spaSim-3D/scripts/spaSim-3D & SPIAT-3D testing/analysis2D_tables/ringed")
ringed_MS_df <- read.table("ringed_slices_MS_df.csv")
ringed_NMS_df <- read.table("ringed_slices_NMS_df.csv")
ringed_ACINP_df <- read.table("ringed_slices_ACINP_df.csv")
ringed_AE_df <- read.table("ringed_slices_AE_df.csv")

ringed_MS_plot <- plot_gradient_metrics_type1(ringed_spes_table, ringed_MS_df, "MS", "ring_width_factor")
ringed_NMS_plot <- plot_gradient_metrics_type1(ringed_spes_table, ringed_NMS_df, "NMS", "ring_width_factor")
ringed_ACINP_plot <- plot_gradient_metrics_type1(ringed_spes_table, ringed_ACINP_df, "ACINP", "ring_width_factor")
ringed_AE_plot <- plot_gradient_metrics_type1(ringed_spes_table, ringed_AE_df, "AE", "ring_width_factor")

setwd("~/R/plots/2D")
saveRDS(ringed_MS_plot, "ringed_MS_plot2D.RDS")
saveRDS(ringed_NMS_plot, "ringed_NMS_plot2D.RDS")
saveRDS(ringed_ACINP_plot, "ringed_ACINP_plot2D.RDS")
saveRDS(ringed_AE_plot, "ringed_AE_plot2D.RDS")

### 3.4. ringed spes ACIN, CKR ------------------------------------------------

# Read ringed ACIN, CKR
setwd("~/R/spaSim-3D/scripts/spaSim-3D & SPIAT-3D testing/analysis2D_tables/ringed")
ringed_ACIN_df <- read.table("ringed_slices_ACIN_df.csv")
ringed_CKR_df <- read.table("ringed_slices_CKR_df.csv")

# Get plots
ringed_ACIN_plot <- plot_gradient_metrics_type2(ringed_spes_table, ringed_ACIN_df, "ACIN", "ring_width_factor", 20, 100)
ringed_CKR_plot <- plot_gradient_metrics_type2(ringed_spes_table, ringed_CKR_df, "CKR", "ring_width_factor", 20, 100)

setwd("~/R/plots/2D")
saveRDS(ringed_ACIN_plot, "ringed_ACIN_plot2D.RDS")
saveRDS(ringed_CKR_plot, "ringed_CKR_plot2D.RDS")

### 3.5. ringed spes SAC ------------------------------------------------------

# Read ringed_SAC_df
setwd("~/R/spaSim-3D/scripts/spaSim-3D & SPIAT-3D testing/analysis2D_tables/ringed")
ringed_prop_SAC_df <- read.table("ringed_slices_prop_SAC_df.csv")
ringed_entropy_SAC_df <- read.table("ringed_slices_entropy_SAC_df.csv")

ringed_prop_SAC_plot <- plot_proportion_SAC(ringed_spes_table, ringed_prop_SAC_df, "ring_width_factor")
ringed_entropy_SAC_plot <- plot_entropy_SAC(ringed_spes_table, ringed_entropy_SAC_df, "ring_width_factor")

setwd("~/R/plots/2D")
saveRDS(ringed_prop_SAC_plot, "ringed_prop_SAC_plot2D.RDS")
saveRDS(ringed_entropy_SAC_plot, "ringed_entropy_SAC_plot2D.RDS")

### 3.6. ringed spes prevalence ------------------------------------------------

# Read ringed prevalence dfs
setwd("~/R/spaSim-3D/scripts/spaSim-3D & SPIAT-3D testing/analysis2D_tables/ringed")
ringed_prop_prevalence_df <- read.table("ringed_slices_prop_prevalence_df.csv")
ringed_entropy_prevalence_df <- read.table("ringed_slices_entropy_prevalence_df.csv")

ringed_prop_prevalence_plot <- plot_proportion_prevalence(ringed_spes_table, ringed_prop_prevalence_df, "ring_width_factor")
ringed_entropy_prevalence_plot <- plot_entropy_prevalence(ringed_spes_table, ringed_entropy_prevalence_df, "ring_width_factor")
ringed_prop_prevalence_AUC_plot <- plot_proportion_prevalence_AUC(ringed_spes_table, ringed_prop_prevalence_df, "ring_width_factor")
ringed_entropy_prevalence_AUC_plot <- plot_entropy_prevalence_AUC(ringed_spes_table, ringed_entropy_prevalence_df, "ring_width_factor")

setwd("~/R/plots/2D")
saveRDS(ringed_prop_prevalence_plot, "ringed_prop_prevalence_plot2D.RDS")
saveRDS(ringed_entropy_prevalence_plot, "ringed_entropy_prevalence_plot2D.RDS")
saveRDS(ringed_prop_prevalence_AUC_plot, "ringed_prop_prevalence_AUC_plot2D.RDS")
saveRDS(ringed_entropy_prevalence_AUC_plot, "ringed_entropy_prevalence_AUC_plot2D.RDS")
...
separated_AMD_df <- read.table("separated_slices_AMD_df.csv")
...
setwd("~/R/plots/2D")
saveRDS(separated_A_AMD_plot, "separated_A_AMD_plot2D.RDS")
saveRDS(separated_B_AMD_plot, "separated_B_AMD_plot2D.RDS")

### 4.3. separated spes MS, NMS, ACINP, AE -----------------------------------

# Read separated MS, NMS, ACINP, AE dfs
setwd("~/R/spaSim-3D/scripts/spaSim-3D & SPIAT-3D testing/analysis2D_tables/separated")
separated_MS_df <- read.table("separated_slices_MS_df.csv")
separated_NMS_df <- read.table("separated_slices_NMS_df.csv")
separated_ACINP_df <- read.table("separated_slices_ACINP_df.csv")
separated_AE_df <- read.table("separated_slices_AE_df.csv")
...
setwd("~/R/plots/2D")
saveRDS(separated_A_MS_plot, "separated_A_MS_plot2D.RDS")
saveRDS(separated_A_NMS_plot, "separated_A_NMS_plot2D.RDS")
saveRDS(separated_A_ACINP_plot, "separated_A_ACINP_plot2D.RDS")
saveRDS(separated_A_AE_plot, "separated_A_AE_plot2D.RDS")

saveRDS(separated_B_MS_plot, "separated_B_MS_plot2D.RDS")
saveRDS(separated_B_NMS_plot, "separated_B_NMS_plot2D.RDS")
saveRDS(separated_B_ACINP_plot, "separated_B_ACINP_plot2D.RDS")
saveRDS(separated_B_AE_plot, "separated_B_AE_plot2D.RDS")

### 4.4. separated spes ACIN, CKR ------------------------------------------------

# Read separated ACIN, CKR
setwd("~/R/spaSim-3D/scripts/spaSim-3D & SPIAT-3D testing/analysis2D_tables/separated")
separated_ACIN_df <- read.table("separated_slices_ACIN_df.csv")
separated_CKR_df <- read.table("separated_slices_CKR_df.csv")
...
setwd("~/R/plots/2D")
saveRDS(separated_A_ACIN_plot, "separated_A_ACIN_plot2D.RDS")
saveRDS(separated_A_CKR_plot, "separated_A_CKR_plot2D.RDS")

saveRDS(separated_B_ACIN_plot, "separated_B_ACIN_plot2D.RDS")
saveRDS(separated_B_CKR_plot, "separated_B_CKR_plot2D.RDS")

### 4.5. separated spes SAC ------------------------------------------------------

# Read separated_SAC_df
setwd("~/R/spaSim-3D/scripts/spaSim-3D & SPIAT-3D testing/analysis2D_tables/separated")
separated_prop_SAC_df <- read.table("separated_slices_prop_SAC_df.csv")
separated_entropy_SAC_df <- read.table("separated_slices_entropy_SAC_df.csv")
...
setwd("~/R/plots/2D")
saveRDS(separated_A_prop_SAC_plot, "separated_A_prop_SAC_plot2D.RDS")
saveRDS(separated_A_entropy_SAC_plot, "separated_A_entropy_SAC_plot2D.RDS")

saveRDS(separated_B_prop_SAC_plot, "separated_B_prop_SAC_plot2D.RDS")
saveRDS(separated_B_entropy_SAC_plot, "separated_B_entropy_SAC_plot2D.RDS")

### 4.6. separated spes prevalence ------------------------------------------------

# Read separated prevalence dfs
setwd("~/R/spaSim-3D/scripts/spaSim-3D & SPIAT-3D testing/analysis2D_tables/separated")
separated_prop_prevalence_df <- read.table("separated_slices_prop_prevalence_df.csv")
separated_entropy_prevalence_df <- read.table("separated_slices_entropy_prevalence_df.csv")
...
setwd("~/R/plots/2D")
saveRDS(separated_A_prop_prevalence_plot, "separated_A_prop_prevalence_plot2D.RDS")
saveRDS(separated_A_entropy_prevalence_plot, "separated_A_entropy_prevalence_plot2D.RDS")
saveRDS(separated_A_prop_prevalence_AUC_plot, "separated_A_prop_prevalence_AUC_plot2D.RDS")
saveRDS(separated_A_entropy_prevalence_AUC_plot, "separated_A_entropy_prevalence_AUC_plot2D.RDS")

saveRDS(separated_B_prop_prevalence_plot, "separated_B_prop_prevalence_plot2D.RDS")
saveRDS(separated_B_entropy_prevalence_plot, "separated_B_entropy_prevalence_plot2D.RDS")
saveRDS(separated_B_prop_prevalence_AUC_plot, "separated_B_prop_prevalence_AUC_plot2D.RDS")
saveRDS(separated_B_entropy_prevalence_AUC_plot, "separated_B_entropy_prevalence_AUC_plot2D.RDS")
...
for (metric in metrics) {
  for (arrangement in arrangements) {
    plot_file_name <- paste(arrangement, "_", metric, "_plot2D.RDS", sep = "")
...
setwd("~/R/plots/2D_no_bg_noise")
saveRDS(mixed_AMD_plot, "mixed_AMD_plot2D_no_bg_noise.RDS")
...
setwd("~/R/plots/2D_no_bg_noise")
saveRDS(mixed_MS_plot, "mixed_MS_plot2D_no_bg_noise.RDS")
saveRDS(mixed_NMS_plot, "mixed_NMS_plot2D_no_bg_noise.RDS")
saveRDS(mixed_ACINP_plot, "mixed_ACINP_plot2D_no_bg_noise.RDS")
saveRDS(mixed_AE_plot, "mixed_AE_plot2D_no_bg_noise.RDS")
...
setwd("~/R/plots/2D_no_bg_noise")
saveRDS(mixed_ACIN_plot, "mixed_ACIN_plot2D_no_bg_noise.RDS")
saveRDS(mixed_CKR_plot, "mixed_CKR_plot2D_no_bg_noise.RDS")
...
setwd("~/R/plots/2D_no_bg_noise")
saveRDS(mixed_prop_SAC_plot, "mixed_prop_SAC_plot2D_no_bg_noise.RDS")
saveRDS(mixed_entropy_SAC_plot, "mixed_entropy_SAC_plot2D_no_bg_noise.RDS")
...
setwd("~/R/plots/2D_no_bg_noise")
saveRDS(mixed_prop_prevalence_plot, "mixed_prop_prevalence_plot2D_no_bg_noise.RDS")
saveRDS(mixed_entropy_prevalence_plot, "mixed_entropy_prevalence_plot2D_no_bg_noise.RDS")
saveRDS(mixed_prop_prevalence_AUC_plot, "mixed_prop_prevalence_AUC_plot2D_no_bg_noise.RDS")
saveRDS(mixed_entropy_prevalence_AUC_plot, "mixed_entropy_prevalence_AUC_plot2D_no_bg_noise.RDS")
...
setwd("~/R/plots/2D_no_bg_noise")
saveRDS(ringed_AMD_plot, "ringed_AMD_plot2D_no_bg_noise.RDS")
...
setwd("~/R/plots/2D_no_bg_noise")
saveRDS(ringed_MS_plot, "ringed_MS_plot2D_no_bg_noise.RDS")
saveRDS(ringed_NMS_plot, "ringed_NMS_plot2D_no_bg_noise.RDS")
saveRDS(ringed_ACINP_plot, "ringed_ACINP_plot2D_no_bg_noise.RDS")
saveRDS(ringed_AE_plot, "ringed_AE_plot2D_no_bg_noise.RDS")
...
setwd("~/R/plots/2D_no_bg_noise")
saveRDS(ringed_ACIN_plot, "ringed_ACIN_plot2D_no_bg_noise.RDS")
saveRDS(ringed_CKR_plot, "ringed_CKR_plot2D_no_bg_noise.RDS")
...
setwd("~/R/plots/2D_no_bg_noise")
saveRDS(ringed_prop_SAC_plot, "ringed_prop_SAC_plot2D_no_bg_noise.RDS")
saveRDS(ringed_entropy_SAC_plot, "ringed_entropy_SAC_plot2D_no_bg_noise.RDS")
...
setwd("~/R/plots/2D_no_bg_noise")
saveRDS(ringed_prop_prevalence_plot, "ringed_prop_prevalence_plot2D_no_bg_noise.RDS")
saveRDS(ringed_entropy_prevalence_plot, "ringed_entropy_prevalence_plot2D_no_bg_noise.RDS")
saveRDS(ringed_prop_prevalence_AUC_plot, "ringed_prop_prevalence_AUC_plot2D_no_bg_noise.RDS")
saveRDS(ringed_entropy_prevalence_AUC_plot, "ringed_entropy_prevalence_AUC_plot2D_no_bg_noise.RDS")
...
setwd("~/R/plots/2D_no_bg_noise")
saveRDS(separated_A_AMD_plot, "separated_A_AMD_plot2D_no_bg_noise.RDS")
saveRDS(separated_B_AMD_plot, "separated_B_AMD_plot2D_no_bg_noise.RDS")
...
setwd("~/R/plots/2D_no_bg_noise")
saveRDS(separated_A_MS_plot, "separated_A_MS_plot2D_no_bg_noise.RDS")
saveRDS(separated_A_NMS_plot, "separated_A_NMS_plot2D_no_bg_noise.RDS")
saveRDS(separated_A_ACINP_plot, "separated_A_ACINP_plot2D_no_bg_noise.RDS")
saveRDS(separated_A_AE_plot, "separated_A_AE_plot2D_no_bg_noise.RDS")

saveRDS(separated_B_MS_plot, "separated_B_MS_plot2D_no_bg_noise.RDS")
saveRDS(separated_B_NMS_plot, "separated_B_NMS_plot2D_no_bg_noise.RDS")
saveRDS(separated_B_ACINP_plot, "separated_B_ACINP_plot2D_no_bg_noise.RDS")
saveRDS(separated_B_AE_plot, "separated_B_AE_plot2D_no_bg_noise.RDS")
...
setwd("~/R/plots/2D_no_bg_noise")
saveRDS(separated_A_ACIN_plot, "separated_A_ACIN_plot2D_no_bg_noise.RDS")
saveRDS(separated_A_CKR_plot, "separated_A_CKR_plot2D_no_bg_noise.RDS")

saveRDS(separated_B_ACIN_plot, "separated_B_ACIN_plot2D_no_bg_noise.RDS")
saveRDS(separated_B_CKR_plot, "separated_B_CKR_plot2D_no_bg_noise.RDS")
...
setwd("~/R/plots/2D_no_bg_noise")
saveRDS(separated_A_prop_SAC_plot, "separated_A_prop_SAC_plot2D_no_bg_noise.RDS")
saveRDS(separated_A_entropy_SAC_plot, "separated_A_entropy_SAC_plot2D_no_bg_noise.RDS")

saveRDS(separated_B_prop_SAC_plot, "separated_B_prop_SAC_plot2D_no_bg_noise.RDS")
saveRDS(separated_B_entropy_SAC_plot, "separated_B_entropy_SAC_plot2D_no_bg_noise.RDS")
...
setwd("~/R/plots/2D_no_bg_noise")
saveRDS(separated_A_prop_prevalence_plot, "separated_A_prop_prevalence_plot2D_no_bg_noise.RDS")
saveRDS(separated_A_entropy_prevalence_plot, "separated_A_entropy_prevalence_plot2D_no_bg_noise.RDS")
saveRDS(separated_A_prop_prevalence_AUC_plot, "separated_A_prop_prevalence_AUC_plot2D_no_bg_noise.RDS")
saveRDS(separated_A_entropy_prevalence_AUC_plot, "separated_A_entropy_prevalence_AUC_plot2D_no_bg_noise.RDS")

saveRDS(separated_B_prop_prevalence_plot, "separated_B_prop_prevalence_plot2D_no_bg_noise.RDS")
saveRDS(separated_B_entropy_prevalence_plot, "separated_B_entropy_prevalence_plot2D_no_bg_noise.RDS")
saveRDS(separated_B_prop_prevalence_AUC_plot, "separated_B_prop_prevalence_AUC_plot2D_no_bg_noise.RDS")
saveRDS(separated_B_entropy_prevalence_AUC_plot, "separated_B_entropy_prevalence_AUC_plot2D_no_bg_noise.RDS")
...
pdf("plots_no_bg_noise.pdf", width = 15, height = 10)

for (metric in metrics) {
  for (arrangement in arrangements) {
    plot_file_name <- paste(arrangement, "_", metric, "_plot2D_no_bg_noise.RDS", sep = "")
    print(readRDS(plot_file_name))
  }
}
dev.off()