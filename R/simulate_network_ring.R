...
#' @param ring_properties A list containing the properties of the network 
...
#'     with the new network with ring cluster and the corresponding metadata.
#'
#' @examples
#' # Simulate background
...
#'                                            
#' # Simulate cluster
#' network_ring_cluster <- simulate_network_ring(bg_r,
