...
bg_cluster <- simulate_clusters3D(bg,
                                  ...
                                  cluster_properties = list(
                                    ...
                                    C2 = list(
                                      name_of_cluster_cell = "B",
                                      infiltration_types = NULL,
                                      infiltration_proportions = NULL,
                                      shape = "Sphere",
                                      radius = 12,
                                      centre_loc = c(80, 80, 80)
                                    )
                                  ),
                                  plot_image = F)

plot_cell_categories3D(bg_cluster,
                       cell_types_of_interest = c("A", "B", "Others"),
...
3. Increasing area of colocalised A and B cells
```{r echo=FALSE}
bg_cluster <- simulate_clusters3D(bg,
                                  n_clusters = 1,
                                  cluster_properties = list(
...
plot_cell_categories3D(bg_mix,
                       ...
                       colour_vector = c("orange", "skyblue"))
```


4. Increasing area of A cells
```{r echo=FALSE}
bg_cluster <- simulate_clusters3D(bg_mix,
                                  n_clusters = 1,
                                  cluster_properties = list(
                                    C1 = list(
                                        name_of_cluster_cell = "A",
...
plot_cell_categories3D(bg_mix,
                       cell_types_of_interest = "A",
                       colour_vector = "orange")
```