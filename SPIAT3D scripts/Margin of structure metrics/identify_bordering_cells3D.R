...
#' @param reference_cell_type String. Cells of this cell type will be used for border
#'   detection.
#' @param feature_colname String that specifies the column of `reference_cell_type`.
...
#' reference_cell_type = "Tumour", feature_colname = "Cell.Type", n_to_exclude = 10)
#' n_clusters <- attr(spe_border, "n_of_clusters") # get the number of clusters
#' n_clusters

identify_bordering_cells3D <- function(spe_object, 
                                       reference_cell_type, 
  ...
  tumour_in_polygon <- 
    allcells_in_polygon[which(allcells_in_polygon[,feature_colname] == reference_cell_type),]
